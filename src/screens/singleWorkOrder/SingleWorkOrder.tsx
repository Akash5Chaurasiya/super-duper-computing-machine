...
const SingleWorkOrder = ({ navigation }: any) => {
    ...
    const startAnimation = (toValue: any) => {
        Animated.timing(animatedValue, {
            ...
            setActiveTab(toValue === 1 ? 'Logs' : 'Current Slips');
        });
    };
        ...
        <View>
                ...
                <View style={styles.container}>
                    <View style={styles.sliderContainer}>
                        ...
                        >
                            ...
                            >
                                {loading ? "Loading WorkOrder Logs ..." : "WorkOrder Logs"}
                            </Animated.Text>
                        </Pressable>
                    </View>
                </View>
            ...
            <View style={{}}>
                {activeTab == 'Current Slips' ? (
                    ...
                    <Logs setLoading1={setLoading} navigation={navigation} id={ele.id} uniqueProcess={uniqueProcessNames} />
                )}
            </View>
            <View>
