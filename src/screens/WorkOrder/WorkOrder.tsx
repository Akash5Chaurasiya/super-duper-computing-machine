...
import Picker1 from '../../components/Picker/Picker1';
import { enums, enums2, enums3, enums4 } from '../../constants/constant';
...
const WorkOrder: React.FC<Props> = ({ navigation }: any) => {
    ...
    }, [auth.authData, selectedOption1, allWorkOrderError]);
    ...
    const manipulateWorkOrderList = () => {
        ...
        if (selectedOption5 != null) {
            if (selectedOption5 == "open") {
                updatedList = updatedList.filter((el) => el.status == "pending" || el.status == "inProgress");
            } else if (selectedOption5 == "completed") {
                updatedList = updatedList.filter((el) => el.status == "completed");
            }
        }
    ...
    const memoizedWorkOrderList = useMemo(() => manipulateWorkOrderList(), [
        workOrderListed,
        selectedOption4,
        selectedOption5,
        searchQuery,
                ...
                <View style={{}}>
                    ...
                    <ScrollView horizontal={true} contentContainerStyle={{ flexGrow: 1 }}>
                        <View style={{
                            ...
                            <Picker1 setSelected={setSelectedOption5} selectedOption={selectedOption5} val={enums} />
                            <Picker1 setSelected={setSelectedOption4} selectedOption={selectedOption4} val={enums2} />
                            <Picker1 setSelected={setSelectedOption1} selectedOption={selectedOption1} val={enums3} />
                            <Picker1 setSelected={setSelectedOption2} selectedOption={selectedOption2} val={enums4} />
                        </View>
                    </ScrollView >
                    <View style={{ marginTop: 15, height: responsiveHeight(62) }}>
                        <FlatList
                            data={memoizedWorkOrderList}
                            renderItem={(e) => (
                                <View>
                                    <TouchableOpacity
                                        key={Math.random()}
