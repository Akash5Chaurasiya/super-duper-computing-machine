...
import {  useGetAllEmployeesQuery, useGetAllMachinesMutation } from '../../redux/features/apis2/Manufacturing';
...
const SingleProgramLogs = ({ navigation }: any) => {
    ...
    const newArray1 = employeeData.map((employee: any) => {
        return {
    ...
    const newArray2 = filteredTrueEmployees.map((employee: any) => {
        return {
            id: employee?._id,
            name: employee?.name,
            profilePic: (employee?.profilePicture) ? (employee?.profilePicture) : ('https://cdn-icons-png.flaticon.com/512/3135/3135715.png')
    ...
    const newMachineArray1 = machineData.map((employee: any) => ({
        id: employee?.machine._id,
        name: employee?.machine.machineName,
    }));
    const newMachineArray2 = filteredFalseMachines.map((employee: any) => ({
        id: employee?._id,
        name: employee?.machineName,
    }));
    const newMachineArray=[...newMachineArray1,...newMachineArray2];
    console.log(newMachineArray1)
                                ...
                                <View style={{ flexDirection: 'column' }}>
                                    ...
                                    >
                                        <View style={{ flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.5)', justifyContent: 'center', alignItems: 'center' }}>
                                            <View style={{ backgroundColor: 'white', borderRadius: 10, width: '80%', flex: 1, maxHeight: '45%' }}>
